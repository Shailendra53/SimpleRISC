...
void Core::decode() {
	...
	if( !(opcode5 == 1 || ( opcode5 == 0 && opcode3 == 1 && opcode1 == 1 && ( opcode4 == 1 || opcode2 == 0) ) ) 	|| 	(opcode5 == 1 && opcode4 == 0 && opcode3 == 0 && opcode2 == 1 && opcode1 == 1) || (opcode5 == 1 && opcode4 == 0 && opcode3 == 1 && opcode2 == 1 && opcode1 == 0)){
		temp_isWb = true;
		//pprint(2)<<"isWb ";
	}
	else{
	...
	if( opcode5 == 1 && opcode4 == 0 && (	(opcode3 == 0 && opcode2 == 1) || (opcode3 == 1 && opcode2 == 0) ) 	){
		temp_isUbranch = true;
		//pprint(2)<<"isUbranch ";
	}
	else{
	...
	else if(opcode5 == 1 && opcode4 == 0 && opcode3 == 1 && opcode2 == 1 && opcode1 == 0){
		temp_isAda = true;
		//pprint(2)<<"isAda ";
	}
	else{
...
void Core::execute() {
	...
	bool temp_isAda = of_ex.isAda.Read();
...
void Core::write_back() {
	...
	bool temp_isAda = ma_rw.isAda.Read();
...
bool Core::checkValidPC(unsigned int testPC){
	...
	if (inst_bitset(testInst,28, 32) < 23) {
		return true;
	}
...
bool Core::check_data_conflict(PipelineRegister& A, PipelineRegister& B){
	...
	if (B_opcode5 == 1 && B_opcode4 == 0 && B_opcode3 == 1 && B_opcode2 == 0 && B_opcode1 == 1){
		return false;	//B is blt
	}
